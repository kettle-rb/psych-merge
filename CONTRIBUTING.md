...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/psych/merge/my_class.rb` -> `spec/psych/merge/my_class_spec.rb`.
...
[🧪build]: https://github.com/kettle-rb/psych-merge/actions
[🤝conduct]: https://gitlab.com/kettle-rb/psych-merge/-/blob/main/CODE_OF_CONDUCT.md
