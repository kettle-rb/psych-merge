...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/psych/merge/version.rb", mod) }::Psych::Merge::Version::VERSION
  else
    ...
    require "psych/merge/version"
    Psych::Merge::Version::VERSION
  end
